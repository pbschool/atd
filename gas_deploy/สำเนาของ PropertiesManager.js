...
//     SpreadsheetApp.getUi().alert('Error', `ไม่สามารถบันทึกค่า property '${key}' ได้: ${e.message}`, SpreadsheetApp.getUi().ButtonSet.OK);
//   }
// }
...
//   // Changed getActiveSpreadsheet to getActiveSpreadsheet() to call the function
